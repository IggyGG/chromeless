...
All five authenticated build manifests now use an ephemeral `GIT_ASKPASS`
...
credentials and a Git substitute. Fifteen cases cover each manifest's success,
shallow-clone refusal and total failure, verify authentication received the
