...
| [`file-upload-chunk-vanishes.md`](./file-upload-chunk-vanishes.md) | **ROOT-CAUSED 2026-09-08** — `HandleEnd` hashed the file before the chunk's write had run; fix in `24ebd98`, awaiting a live run | (was: `<input type=file>` ended in "no file selected" with every layer apparently working) |
